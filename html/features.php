<?php
    ...
    $cssAssets = [ "fonts", "variables", "ui", "header", "nav", "live", "features", "compatibility" ];
...
<html>
    ...
    <body>
        ...
        <div id="uiSubBanner">
            <div class="uiTitlePill">How do you have features?</div>
        </div>
        ...
        <div class="uiSubDescription">
            <p>Every channel has its quirks — this is mine! I tinker with code for fun, which means I've built
                ...
                It's all part of the chaos. For science!
            </p>

            <p>Interacting with my stream requires a new currency that I call Airo Gems. You can do a lot of
                things including spawn mobs, give potion effects, play sounds and run custom scripts I label as pranks.
            </p>
        </div>

        <div class="uiSectionHang">
            <div class="uiTitlePill"><span>Stream Interaction</span></div>
