...
class ConfigManager {
    ...
    public function getGame(string $name): ?Game {
        return $this->gameManager->getAllGames()[$name] ?? null;
    }
    ...
    // SETTERS
    public function setActiveGameAndProfile(string $game, string $profile) { $this->configStore->setActiveGameAndProfile($game, $profile); }
}
